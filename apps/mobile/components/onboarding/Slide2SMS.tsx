 ...
 *  - Top: bank message bubble with envelope icon + sender + "2 min ago".
 *  - Middle: down arrow + "DETECTED" divider.
 *  - Bottom: parsed transaction card (amount + Groceries chip + auto-imported
 *    status row).
 *
...
export function Slide2SMS(): React.ReactElement {
  ...
  return (
    <PitchMockCard>
      {/* Bank message bubble */}
      <View className="rounded-xl bg-slate-50 p-3 dark:bg-slate-700/50">
