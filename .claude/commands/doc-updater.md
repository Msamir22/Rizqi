...
description:
  ...
  and documentation. Generates architectural maps, updates READMEs and guides.
---
...
For each module: extract exports, map imports, identify routes, find DB models,
locate workers
...
**Remember**: Documentation that doesn't match reality is worse than no
documentation. Always generate from the source of truth.
