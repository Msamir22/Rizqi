...
through the `@monyvi/db` package index. The file is auto-generated by
...
from `@monyvi/db`. The contract file reflects this convention.
...
| Are sign-out during onboarding and back/forward nav in scope? | No — tracked as [#242](https://github.com/Msamir22/Monyvi/issues/242) and [#243](https://github.com/Msamir22/Monyvi/issues/243). |
